...
using ChushkaApp.ViewModels.User;
...
namespace ChushkaApp.Controllers
{
    public class UsersController : BaseController
    {
        ...
        public IHttpResponse Register(RegisterInputViewModel model)
        {
            ...
            if (string.IsNullOrWhiteSpace(model.FullName) || model.FullName.Length < 4)
            {
                return this.BadRequestErrorWithView("Please enter your full name.");
            }
